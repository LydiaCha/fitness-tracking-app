...
export function createProfileStyles(theme: AppThemeType) {
  return StyleSheet.create({
    ...
    headerRow:    { flexDirection: 'row', alignItems: 'center', paddingTop: 8, paddingBottom: 4 },
    headerTitle:  { flex: 1, fontSize: 26, fontWeight: '800', color: theme.textPrimary, letterSpacing: -0.3 },
    ...
    statLabel:    { fontSize: 10, color: theme.textMuted, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.8 },
    ...
    rowValue:     { fontSize: 13, color: theme.textMuted, maxWidth: 180, textAlign: 'right', lineHeight: 18 },
    chevron:      { fontSize: 16, color: theme.textMuted, marginLeft: 8 },
    ...
    timeLabel:    { fontSize: 10, color: theme.textMuted, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 6 },
    ...
    todayBadge:   { backgroundColor: theme.primary + '22', borderRadius: 6, paddingHorizontal: 7, paddingVertical: 2, marginRight: 6 },
    todayText:    { fontSize: 10, fontWeight: '800', color: theme.primary, letterSpacing: 0.8, textTransform: 'uppercase' },
    ...
    scheduleDayPillActive: { backgroundColor: theme.gym, borderColor: theme.gym },
