...
export function createNutritionStyles(theme: AppThemeType) {
  return StyleSheet.create({
    ...
    momentumTitle:  { fontSize: 16, fontWeight: '700', color: theme.textPrimary },
    ...
    weightTitle:      { fontSize: 16, fontWeight: '700', color: theme.textPrimary },
    ...
    historyLabel:  { fontSize: 11, color: theme.textMuted, marginBottom: 8, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.8 },
    ...
    stepsTitle:       { fontSize: 16, fontWeight: '700', color: theme.textPrimary },
    ...
    coachSectionTitle:   { fontSize: 11, fontWeight: '800', color: theme.textMuted, letterSpacing: 0.8, textTransform: 'uppercase', marginBottom: 10 },
