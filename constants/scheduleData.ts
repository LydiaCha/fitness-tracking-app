...
export const WEEK_SCHEDULE: DaySchedule[] = [
  {
    ...
    events: [
      ...
      { time: '4:00 AM', label: 'Meal 3 – Work meal', detail: '2 scrambled eggs + 2 slices wholegrain toast + ½ avocado + cherry tomatoes. ~420 kcal, 25g protein.', type: 'meal', recipeId: 'egg-avo-toast', recipeType: 'meal' },
      { time: '6:00 AM', label: 'Pre-sleep wind-down snack', detail: '1 tbsp almond butter + 1 rice cake OR small handful of walnuts. Light, easy to digest.', type: 'snack', recipeId: 'almond-rice-cake', recipeType: 'meal' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '2:00 AM', label: 'Mid-work snack', detail: '1 banana + 20g mixed nuts OR protein bar (20g+ protein). ~250 kcal.', type: 'snack', recipeId: 'banana-nuts', recipeType: 'meal' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '2:00 AM', label: 'Mid-work snack', detail: 'String cheese × 2 + 10 wholegrain crackers + handful grapes. ~220 kcal.', type: 'snack', recipeId: 'string-cheese-crackers', recipeType: 'meal' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '12:00 AM', label: 'WORK BEGINS', detail: 'Work starts.', type: 'work', duration: '8 hrs' },
      { time: '2:00 AM', label: 'Mid-work snack', detail: 'Mixed nuts (30g) + a piece of dark chocolate (20g). ~240 kcal.', type: 'snack', recipeId: 'mixed-nuts-choc', recipeType: 'meal' },
      { time: '4:00 AM', label: 'Meal 3 – Work meal', detail: 'Sweet potato (1 medium, roasted) + 2 boiled eggs + side salad. ~400 kcal.', type: 'meal', recipeId: 'sweet-potato-eggs', recipeType: 'meal' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '7:30 PM', label: 'Meal 2 – Dinner', detail: 'Baked chicken thighs + roasted sweet potato wedges + steamed green beans + garlic butter. ~550 kcal, 40g protein.', type: 'meal', recipeId: 'baked-chicken-thighs', recipeType: 'meal' },
      { time: '9:00 PM', label: 'Free time', detail: 'Relaxed evening. Limit blue light 30 min before work starts.', type: 'free' },
      { time: '11:00 PM', label: 'Light snack + creatine', detail: 'Banana + peanut butter OR protein bar. Creatine (5g) — take daily, even on rest days.', type: 'snack', recipeId: 'banana-pb', recipeType: 'meal' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '11:30 PM', label: 'Light snack + creatine', detail: 'Grapes + string cheese OR small bowl of cereal + milk.', type: 'snack', recipeId: 'string-cheese-crackers', recipeType: 'meal' },
      { time: '12:00 AM', label: 'WORK BEGINS', detail: 'Work starts — even on weekends. Stay hydrated.', type: 'work', duration: '8 hrs' },
      { time: '2:00 AM', label: 'Mid-work snack', detail: 'Protein bar OR mixed nuts + dark chocolate. ~220 kcal.', type: 'snack', recipeId: 'mixed-nuts-choc', recipeType: 'meal' },
