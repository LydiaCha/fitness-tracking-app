...
export const WEEK_SCHEDULE: DaySchedule[] = [
  {
    ...
    events: [
      ...
      { time: '2:00 AM', label: 'Mid-work snack', detail: 'Cottage cheese (100g) + apple slices OR Greek yogurt + almonds. ~200 kcal.', type: 'snack' },
      { time: '3:30 AM', label: 'Water check', detail: 'Drink 250ml water. Walk around for 5 minutes.', type: 'water' },
      { time: '4:00 AM', label: 'Meal 3 – Work meal', detail: '2 scrambled eggs + 2 slices wholegrain toast + ½ avocado + cherry tomatoes. ~420 kcal, 25g protein.', type: 'meal' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '4:00 AM', label: 'Meal 3 – Work meal', detail: 'Tuna (150g) + wholegrain crackers + sliced cucumber + hummus. ~380 kcal, 35g protein.', type: 'meal' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '4:00 AM', label: 'Meal 3 – Work meal', detail: 'Leftover stir-fry OR overnight oats (½ cup oats + milk + 1 scoop protein powder + berries, prepped earlier). ~380 kcal.', type: 'meal' },
      { time: '6:00 AM', label: 'Pre-sleep snack', detail: 'Casein shake OR 100g cottage cheese with cinnamon.', type: 'shake' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '11:00 PM', label: 'Light snack', detail: 'Apple + 2 tbsp almond butter OR rice cakes with cottage cheese.', type: 'snack' },
      ...
      { time: '6:00 AM', label: 'Pre-sleep snack', detail: 'Casein shake or cottage cheese.', type: 'shake' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '12:00 AM', label: 'WORK BEGINS', detail: 'Work starts.', type: 'work', duration: '8 hrs' },
      { time: '2:00 AM', label: 'Mid-work snack', detail: 'Cottage cheese + berries + granola. ~200 kcal.', type: 'snack' },
      { time: '4:00 AM', label: 'Meal 3 – Work meal', detail: 'Greek yogurt (200g) + granola (30g) + mixed berries + drizzle maple syrup + chopped nuts. ~400 kcal.', type: 'meal' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '5:45 PM', label: 'Meal 1 – Pre-workout fuel', detail: 'Chicken + rice bowl: 120g grilled chicken + ½ cup jasmine rice + ½ cup edamame + sesame + soy drizzle. ~480 kcal, 40g protein.', type: 'meal' },
      ...
      { time: '4:00 AM', label: 'Meal 3 – Work meal', detail: 'Wholegrain wrap: tuna + cream cheese + cucumber + spinach + lemon. ~380 kcal.', type: 'meal' },
      { time: '6:00 AM', label: 'Pre-sleep snack', detail: 'Casein shake or cottage cheese.', type: 'shake' },
      { time: '7:30 AM', label: 'Magnesium supplement', detail: 'Magnesium Glycinate 300mg.', type: 'supplement' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '5:30 PM', label: 'Supplements + Meal 1', detail: 'Vitamin D3, Omega-3.\nFull Sunday brekkie: 3 eggs scrambled + smoked salmon + 2 slices rye toast + avocado + spinach. ~550 kcal, 42g protein.', type: 'meal' },
      ...
      { time: '11:30 PM', label: 'Creatine + light snack', detail: 'Orange + 100g cottage cheese. Creatine (5g).', type: 'snack' },
      { time: '12:00 AM', label: 'WORK BEGINS', detail: 'Work starts. New week, new goals.', type: 'work', duration: '8 hrs' },
      { time: '2:00 AM', label: 'Mid-work snack', detail: 'Overnight oats prepped earlier OR Greek yogurt + granola. ~300 kcal.', type: 'snack' },
      { time: '4:00 AM', label: 'Meal 3 – Work meal', detail: 'Batch-cooked chicken + roasted veg (from Sunday prep!) + rice. ~420 kcal, 40g protein.', type: 'meal' },
      { time: '6:00 AM', label: 'Pre-sleep snack', detail: 'Casein shake or casein-rich cottage cheese.', type: 'shake' },
      { time: '7:30 AM', label: 'Magnesium supplement', detail: 'Magnesium Glycinate 300mg.', type: 'supplement' },
